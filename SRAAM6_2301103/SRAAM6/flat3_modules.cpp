...
//					environment() locations:flat3[10-19]
...
{
	//defining module-variables
	flat3[0].init("time",0,"Vehicle time since launch - s","kinematics","diag","");
}
///////////////////////////////////////////////////////////////////////////////
...
void Flat3::init_kinematics(double sim_time,double not_used)
{
...
void Flat3::kinematics(double sim_time,double not_used1,double &not_used2,double &not_used3)
{
	//local module-variables
	double time(0);
	//-------------------------------------------------------------------------
...
void Flat3::def_newton()
{
	...
	flat3[23].init("TAV",0,0,0,0,0,0,0,0,0,"TM of aircraft wrt velocity coor","newton","dia","");
	...
	flat3[26].init("SAEL",0,0,0,"Aircraft position wrt point E - m ","newton","state","com");
	...
	flat3[29].init("psialx",0,"Aircraft heading angle - deg","newton","init/dia","");
	flat3[30].init("thtalx",0,"Aircraft flight path angle - deg","newton","init/dia","");
	...
	flat3[34].init("psial",0,"Aircraft heading angle - rad","newton","out","com");
	flat3[35].init("thtal",0,"Aircraft flight path angle - rad","newton","out","com");
}
