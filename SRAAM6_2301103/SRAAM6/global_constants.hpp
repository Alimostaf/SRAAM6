...
int const NMISSILE=750;					//size of 'misssile' module-variable array
int const NFLAT3=40;					//size of 'flat3' module-variable array 
int const NTARGET=50;					//size of 'target' module-variable array
int const NRECCE=60;					//size of 'recce' module-variable array
int const NEVENT=10;					//max number of events
int const NVAR=10;						//max number of variables to be input at every event 
int const NMARKOV=5;					//max number of Markov noise variables
#endif