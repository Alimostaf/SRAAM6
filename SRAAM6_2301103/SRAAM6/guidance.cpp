...
void Missile::def_guidance()
{
	...
	missile[402].init("ancomx",0,"Normal acceleration command - g's","guidance","out","scrn");
	missile[403].init("alcomx",0,"Lateral acceleration command - g's","guidance","out","scrn");
	...
	missile[461].init("range",0,"Range of target wrt missile - m","guidance","diag","plot");
	missile[462].init("azimuthx",0,"Azimuth of target wrt missile - deg","guidance","diag","plot");
	missile[463].init("elevationx",0,"Elevation of target wrt missile - deg","guidance","diag","plot");
}	
///////////////////////////////////////////////////////////////////////////////
//Guidance module
//Member function of class 'Missile'
...
//               Set by input or in 'seeker' module if break lock occurred
//            6: Terminal (Pro-Nav based on LOS rates only)
//               Set in 'seeker' module  when 'mseek=4'
...
{	
	...
	//diagnostics: range, azimuth, elevation of target wrt missile
	Matrix STBL=STEL-SBEL;
	Matrix POLAR=STBL.pol_from_cart();
	range=POLAR.get_loc(0,0);
	azimuthx=POLAR.get_loc(1,0)*DEG;
	elevationx=POLAR.get_loc(2,0)*DEG;
	//-------------------------------------------------------------------------
	...
	missile[461].gets(range);
	missile[462].gets(azimuthx);
	missile[463].gets(elevationx);
}	
///////////////////////////////////////////////////////////////////////////////
//Midcouse guidance
//Member function of class 'Missile'
