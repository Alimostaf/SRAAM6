...
//060504 Picked up DRMPN6 'kinemataics' module, PZi
///////////////////////////////////////////////////////////////////////////////
...
void Flat6::def_kinematics()
{
	...
	flat6[0].init("time",0,"Vehicle time since launch - s","kinematics","exec","scrn,plot,com");
	flat6[1].init("event_time",0,"Time elapsed during an event - s","kinematics","exec","");
	flat6[2].init("int_step_new",0,"New integration step size  - s","kinematics","data","");
	flat6[3].init("out_step_fact",0,"Factor to modify output, e.g.: plot_step*(1+out_step_fact)  - ND","kinematics","data","");
	flat6[4].init("halt","int",0,"=1: Halting vehicle object via 'input.asc' - ND","kinematics","data","");
	flat6[5].init("stop","int",0,"=1: Stopping vehicle object via 'intercept' module - ND","kinematics","data","");
	flat6[6].init("lconv","int",0, "Flag of type of trajectory termination  - ND","kinematics","diag","plot");
...
void Flat6::init_kinematics(double sim_time,double int_step)
{	
