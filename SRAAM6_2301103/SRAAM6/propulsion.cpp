...
void Missile::def_propulsion()
{
    ...
    missile[59].init("vmass",92,"Vehicle mass - kg","propulsion","out","");
    missile[63].init("thrust",0,"Rocket thrust parallel to vehicle centerline - N","propulsion","out","scrn,plot");
    missile[64].init("xcgref",1.536,"Launch CG aft of vehicle nose - m","propulsion","init","");
    missile[70].init("xcg",1.536,"Vehicle CG aft of vehicle nose - m","propulsion","diag","scrn");
    missile[71].init("ai11",0.308,"Roll moment of inertia - kg*m^2","propulsion","out","");
    missile[72].init("ai33",59.80,"Pitch/Yaw moment of inertia - kg*m^2","propulsion","out","");
