...
void Missile::def_seeker()
{
    ...
    missile[251].init("ththbx",0,"Head pitch angle - deg","seeker","diag","scrn,");
    missile[252].init("phihbx",0,"Head roll angle - deg","seeker","diag","scrn,");
    ...
    missile[276].init("EAHH",0,0,0,"Aimpoint displacement wrt center of F.P. - rad","seeker","diag","");
    ...
    missile[287].init("sigdpy",0,"Pitch sight line spin - rad/s","seeker","out","");
    missile[288].init("sigdpz",0,"Yaw sight line spin - rad/s","seeker","out","");
...
//
//011221 Converted to SRAAM6 by Peter Zipfel
///////////////////////////////////////////////////////////////////////////////
