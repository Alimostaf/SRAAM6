...
Packet Target::loading_packet_init(int num_missile,int num_target,int num_recce)
{
	string id;
	char object[4];
...
Packet Target::loading_packet(int num_missile,int num_target,int num_recce)
{
	int index(0);
	int i(0);
