...
//						guidance() location:target[10-19]
//						control()			target[20-39]
//						forces()			target[40]
//
...
//
// tgt_option = 0 flying out only with initial conditions
//				1 horizontal g-maneuver (specify 'gturn')
//				2 inital fly out and escape maneuver when missile 'skr_mode=4'
//
//020116 Created by Peter Zipfel
//030925 Updated, PZi
///////////////////////////////////////////////////////////////////////////////
...
void Target::def_guidance()
{
	...
	target[10].init("tgt_option","int",0,"=0:steady; =1 hor g-manvr, alpha limtd; =2:escape - ND","guidance","data","");
	target[11].init("guid_gain",0,"Guidance gain for escaping target maneuvers - ND","guidance","data","");
...
// tgt_option = 0 flying out only with initial conditions
//				1 horizontal g-maneuver (specify 'gturn')
//				2 inital fly out and escape maneuver when skr_mode=4
//
//020116 Created by Peter Zipfel
///////////////////////////////////////////////////////////////////////////////
...
//
//F16 aircraft parameter are loaded here for limiting calculations
//
//020116 Created by Peter Zipfel
///////////////////////////////////////////////////////////////////////////////
...
void Target::def_control()
{
	...
	target[22].init("tphi",0,"Time lag constant of bank angle - sec","control","data","");
	...
	target[28].init("tanx",0,"Time lag constant of normal load factor  - sec","control","data","");
